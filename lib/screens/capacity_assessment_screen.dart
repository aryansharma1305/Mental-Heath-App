...
class CapacityAssessmentScreen extends StatefulWidget {
  ...
  @override
  State<CapacityAssessmentScreen> createState() =>
      _CapacityAssessmentScreenState();
}
...
class _CapacityAssessmentScreenState extends State<CapacityAssessmentScreen>
  ...
  Future<void> _loadDoctorProfile() async {
    ...
    if (doctorJson != null) {
      try {
        ...
        debugPrint('Unable to load doctor profile: $e');
      }
    }
  }
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text(
              AppLocalizations.of(context)!.criticalAlertTitle,
        ...
        content: Text(
          AppLocalizations.of(context)!.criticalAlertMessage,
  ...
  Future<void> _submitAssessment() async {
    try {
      ...
      final domainsNeedingLevel2 = AssessmentQuestions.getDomainsNeedingLevel2(
        _responses,
      );
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.assessmentComplete,
                  style: GoogleFonts.poppins(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                  ),
                ...
                Text(
                  '${AppLocalizations.of(context)!.anonymisedId}: ${_patientIdController.text}',
                  style: GoogleFonts.inter(
                    fontSize: 16,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.level2Recommended,
                              style: GoogleFonts.inter(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                                color: AppTheme.warningOrange,
                  ...
                  (e) => Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            e.key.replaceAll(RegExp(r'^[IVXL]+\.\s*'), ''),
                            style: GoogleFonts.inter(
                              fontSize: 12,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text(
                          AppLocalizations.of(context)!.newAssessmentButton,
                          style: GoogleFonts.inter(
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
                          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.of(context)!.assessmentSubtitle,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!.patientInfoTitle,
                          style: GoogleFonts.poppins(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                          ),
                        ...
                        Text(
                          AppLocalizations.of(context)!.patientInfoSubtitle,
                          style: GoogleFonts.inter(
                            fontSize: 13,
                            color: AppTheme.textGrey,
                          ),
                ...
                Text(
                  AppLocalizations.of(context)!.enterIdLabel,
                  style: GoogleFonts.inter(
                    fontSize: 13,
                    fontWeight: FontWeight.w600,
                ...
                TextField(
                  ...
                  decoration: _inputDecoration(
                    AppLocalizations.of(context)!.enterIdHint,
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        AppLocalizations.of(context)!.dsm5Info,
                        style: GoogleFonts.inter(
                          fontSize: 12,
                          color: Colors.white,
                        ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  AppLocalizations.of(context)!.pastTwoWeeks,
                  style: GoogleFonts.inter(
                    fontSize: 12,
                    color: AppTheme.textGrey,
                  ),
                  ...
                  return Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected
                                  ? optionColors[i].withValues(alpha: 0.1)
