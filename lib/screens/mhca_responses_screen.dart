...
class _MHCAResponsesScreenState extends State<MHCAResponsesScreen> {
  ...
  Widget _buildAssessmentCard(Map<String, dynamic> assessment, int index) {
    final patientName = assessment['patient_name'] as String? ?? 'Unknown';
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _detailRow('ID', assessment['patient_id'] as String? ?? ''),
                  _detailRow('Age/Sex', assessment['age_sex'] as String? ?? ''),
                  _detailRow(
                    'Place',
                    assessment['place_of_assessment'] as String? ?? '',
                  ),
                  _detailRow('Purpose', assessment['purpose'] as String? ?? ''),
                  _detailRow(
                    'Diagnosis',
