...
class Level2Domain {
  ...
  final String
  instrument; // e.g. "PROMIS Emotional Distress—Depression—Short Form"
...
class DSM5Level2Questions {
  ...
  static final Map<String, Level2Domain> _domains = {
    ...
    'depression': Level2Domain(
      ...
      scoringNote:
          'Sum all items (range 8–40). Higher scores = greater depression severity. '
      ...
      thresholds: const [
        Level2Threshold(
          minScore: 8,
          maxScore: 15,
          severity: 'None to Minimal',
          clinicalNote:
              'No clinically significant depression. Routine monitoring recommended.',
        ),
        Level2Threshold(
          minScore: 16,
          maxScore: 20,
          ...
          clinicalNote:
              'Mild depressive symptoms. Consider psychoeducation and watchful waiting.',
        ),
        Level2Threshold(
          minScore: 21,
          maxScore: 26,
          ...
          clinicalNote:
              'Moderate depression. Consider structured psychological intervention (e.g., CBT) or pharmacotherapy evaluation.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 27,
          ...
          clinicalNote:
              'Severe depression. Urgent psychiatric evaluation and treatment indicated.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'anger': Level2Domain(
      ...
      optionValues: _promisValues,
      scoringNote:
          'Sum all items (range 5–25). Higher scores = greater anger severity. '
      ...
      thresholds: const [
        Level2Threshold(
          ...
          maxScore: 9,
          severity: 'None to Minimal',
          clinicalNote: 'No clinically significant anger. Routine monitoring.',
        ),
        Level2Threshold(
          minScore: 10,
          maxScore: 14,
          severity: 'Mild Anger',
          clinicalNote:
              'Mild anger symptoms. Psychoeducation on anger management may be helpful.',
        ),
        Level2Threshold(
          minScore: 15,
          maxScore: 19,
          severity: 'Moderate Anger',
          clinicalNote:
              'Moderate anger. Consider anger management therapy or psychiatric evaluation.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 20,
          maxScore: 25,
          severity: 'Severe Anger',
          clinicalNote:
              'Severe anger. Psychiatric evaluation indicated. Risk of harm to self or others should be assessed.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'mania': Level2Domain(
      ...
      scoringNote:
          'Sum all items (range 0–20). Score ≥6 indicates probable presence of a manic or hypomanic state.',
      maxScore: 20,
      thresholds: const [
        Level2Threshold(
          minScore: 0,
          maxScore: 5,
          severity: 'No Mania',
          clinicalNote: 'No significant manic symptoms. Routine monitoring.',
        ),
        Level2Threshold(
          minScore: 6,
          maxScore: 9,
          severity: 'Hypomania Likely',
          clinicalNote:
              'Score ≥6 indicates probable hypomanic episode. Psychiatric evaluation for bipolar spectrum disorder recommended.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 10,
          maxScore: 20,
          severity: 'Mania Likely',
          clinicalNote:
              'Score ≥10 indicates probable manic episode. Urgent psychiatric evaluation required.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'anxiety': Level2Domain(
      ...
      questions: const [
        ...
        Level2Question(
          id: 'ax6',
          text: 'I felt like something awful might happen.',
        ),
      ...
      optionValues: _promisValues,
      scoringNote:
          'Sum all items (range 7–35). Higher scores = greater anxiety severity. '
      ...
      thresholds: const [
        Level2Threshold(
          ...
          severity: 'None to Minimal',
          clinicalNote:
              'No clinically significant anxiety. Routine monitoring.',
        ),
        Level2Threshold(
          minScore: 14,
          maxScore: 18,
          ...
          clinicalNote:
              'Mild anxiety symptoms. Consider psychoeducation and stress management.',
        ),
        Level2Threshold(
          minScore: 19,
          maxScore: 23,
          ...
          clinicalNote:
              'Moderate anxiety. Consider CBT, structured psychological therapy, or pharmacotherapy evaluation.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 24,
          ...
          clinicalNote:
              'Severe anxiety. Psychiatric evaluation and treatment urgently recommended.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'somatic': Level2Domain(
      ...
      questions: const [
        ...
        Level2Question(
          id: 's11',
          text: 'Pain or problems during sexual intercourse (if applicable)',
        ),
        Level2Question(
          id: 's12',
      ...
      scoringNote:
          'During the past 4 WEEKS, how much have you been bothered by each symptom? '
      ...
      thresholds: const [
        Level2Threshold(
          ...
          maxScore: 4,
          severity: 'Minimal',
          clinicalNote: 'Minimal somatic symptom burden. Routine monitoring.',
        ),
        Level2Threshold(
          minScore: 5,
          maxScore: 9,
          severity: 'Low',
          clinicalNote:
              'Low somatic symptom burden. Consider evaluation of specific symptoms if distressing.',
        ),
        Level2Threshold(
          minScore: 10,
          maxScore: 14,
          severity: 'Medium',
          clinicalNote:
              'Medium somatic symptom burden. Further evaluation for somatic symptom disorder recommended.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 15,
          ...
          severity: 'High',
          clinicalNote:
              'High somatic symptom burden. Comprehensive medical and psychiatric evaluation required.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'sleep': Level2Domain(
      ...
      questions: const [
        Level2Question(
          id: 'sl1',
          text:
              'My sleep quality was... (1=Very poor, 5=Very good — please reverse your thinking for this item)',
        ),
        ...
        Level2Question(
          id: 'sl6',
          text:
              'I tried to sleep at the wrong times of day (early morning, during the day, early evening).',
        ),
        Level2Question(id: 'sl7', text: 'I had trouble sleeping.'),
        Level2Question(
          id: 'sl8',
          text: 'I woke up too early and could not fall back to sleep.',
        ),
      ],
      optionLabels: _promisOptions,
      optionValues: _promisValues,
      scoringNote:
          'Over the past 7 days. Sum all items (range 8–40). '
      ...
      thresholds: const [
        Level2Threshold(
          ...
          severity: 'None to Minimal',
          clinicalNote:
              'No clinically significant sleep disturbance. Sleep hygiene counselling if requested.',
        ),
        Level2Threshold(
          minScore: 16,
          maxScore: 21,
          severity: 'Mild Sleep Disturbance',
          clinicalNote:
              'Mild sleep disturbance. Consider sleep hygiene education and CBT-I strategies.',
        ),
        Level2Threshold(
          minScore: 22,
          maxScore: 27,
          severity: 'Moderate Sleep Disturbance',
          clinicalNote:
              'Moderate sleep disturbance. Evaluate for insomnia disorder; consider CBT-I or sleep specialist referral.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 28,
          maxScore: 40,
          severity: 'Severe Sleep Disturbance',
          clinicalNote:
              'Severe sleep disturbance. Urgent evaluation required; consider polysomnography referral and pharmacological management.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'repetitive': Level2Domain(
      ...
      thresholds: const [
        Level2Threshold(
          ...
          clinicalNote:
              'Subclinical compulsive symptoms. Monitor; no immediate clinical intervention required.',
        ),
        Level2Threshold(
          minScore: 8,
          maxScore: 11,
          ...
          clinicalNote:
              'Mild OCD symptoms. Consider psychoeducation and CBT/ERP referral for evaluation.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 12,
          ...
          clinicalNote:
              'Moderate OCD symptoms. CBT with Exposure and Response Prevention (ERP) is first-line treatment. Consider SSRI pharmacotherapy.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 16,
          ...
          clinicalNote:
              'Severe OCD. Combination CBT/ERP + pharmacotherapy recommended. Consider urgent psychiatric evaluation.',
          requiresAction: true,
        ),
      ],
    ),
    ...
    'substance': Level2Domain(
      ...
      title: 'Substance Use',
      instrument:
          'NIDA-Modified ASSIST (Alcohol, Smoking, and Substance Involvement Screening Test)',
      questions: const [
        Level2Question(
          id: 'su1',
          text:
              'In your lifetime, which of the following substances have you used (not including use solely for medical reasons)?\n[Tobacco products, Alcohol, Cannabis, Cocaine, Amphetamines, Inhalants, Sedatives, Hallucinogens, Opioids, Other drugs]\n\nRate the MOST RECENTLY used substance\'s frequency below:',
        ),
        Level2Question(
          id: 'su2',
          text:
              'In the PAST THREE MONTHS, how often have you used alcohol (beer, wine, spirits, etc.)?',
        ),
        Level2Question(
          id: 'su3',
          text:
              'In the PAST THREE MONTHS, how often have you used tobacco products (cigarettes, chewing tobacco, cigars, etc.)?',
        ),
        Level2Question(
          id: 'su4',
          text:
              'In the PAST THREE MONTHS, how often have you used cannabis (marijuana, pot, grass, hash, etc.)?',
        ),
        Level2Question(
          id: 'su5',
          text:
              'In the PAST THREE MONTHS, how often have you used cocaine, crack, or other stimulants (amphetamines, meth, ecstasy, etc.)?',
        ),
        Level2Question(
          id: 'su6',
          text:
              'In the PAST THREE MONTHS, how often have you used sedatives, sleeping pills, or anxiolytics (Valium, Xanax, Klonopin, etc.) OTHER THAN as prescribed?',
        ),
        Level2Question(
          id: 'su7',
          text:
              'In the PAST THREE MONTHS, how often have you used opioid pain medications (Vicodin, OxyContin, codeine, heroin, etc.) OTHER THAN as prescribed?',
        ),
        Level2Question(
          id: 'su8',
          text:
              'During the PAST THREE MONTHS, how often have you had a strong desire or urge to use any substance?',
        ),
      ],
      optionLabels: _assistOptions,
      optionValues: _assistValues,
      scoringNote:
          'Each item scored 0/2/3/4/6. Sum all items. '
      ...
      thresholds: const [
        Level2Threshold(
          ...
          severity: 'Low Risk',
          clinicalNote:
              'Low risk substance use or none. Provide substance use information and encourage abstinence or moderation.',
        ),
        Level2Threshold(
          minScore: 4,
          maxScore: 15,
          ...
          clinicalNote:
              'Moderate risk. Brief intervention (SBIRT — Screening, Brief Intervention, and Referral to Treatment) is recommended.',
          requiresAction: true,
        ),
        Level2Threshold(
          minScore: 16,
          maxScore: 48,
          severity: 'High Risk / Likely Dependence',
          clinicalNote:
              'High risk of substance dependence. Referral to specialist substance use treatment services required.',
          requiresAction: true,
        ),
      ],
    ),
  ...
  static List<Level2Domain> getDomainsForFlagged(
    List<String> flaggedLevel1Domains,
  ) {
